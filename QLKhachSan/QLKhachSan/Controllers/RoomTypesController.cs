...
namespace QLKhachSan.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Amount,Note")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Amount,Note")] RoomType roomType)
        {
            if (ModelState.IsValid)
            {
